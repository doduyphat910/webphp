                    ...
                    <a href="javascript:void(0)" class="reply" data-a="<?php echo $value['idBL'];?>">
                      ...
                      <p>
                        ...
                        if(isset($_SESSION['idUser']))
                        {
                          ...
                          {
                            ?>
                            <a href="javascript:void(0)" class="update" data-a="<?php echo $value['idBL'];?>">
                              <small>Sửa</small></a></i></p>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <fieldset  style="display: none;"  class="update-form<?php echo $value['idBL']; ?>">
                         <form action="index.php?p=tin&idTinTuc=<?php echo $idTinTuc?>" method="post">
                          ...
                          <input type="submit" value="Sửa bình luận" class="btn btn-default" 
                            ...
                            <p class="meta"><?php echo $value2['NgayDang']?> 
                              ...
                              <p>
                               ...
                               if(isset($_SESSION['idUser']))
                               {
                                ...
                                {
                                  ?>
                                  <a href="javascript:void(0)" class="updateRep" data-a="<?php echo $value2['idTLBinhLuan'];?>">
                                    <small>Sửa trả lời</small></a></i></p>
                                    <?php
                                  }
                                }
                                ?>
                              ...
                              <fieldset style="display: none;" class="updateREP-form<?php echo $value2['idTLBinhLuan']; ?>">
                               <form action="index.php?p=tin&idTinTuc=<?php echo $idTinTuc?>" method="post">
                                ...
                                <input type="submit" value="Sửa trả lời bình luận" class="btn btn-default" 
