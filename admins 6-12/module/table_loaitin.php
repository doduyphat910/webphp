...
if(isset($_GET['thaotac']))
{
  ...
  ?> 
           ...
           <form action="index.php?table=loaitin&thaotac=update" method="post" enctype="multipart/form-data" >
         ...
         <?php ?>
          ...
          <tr><td>Tình Trạng: </td><td>
             ...
             <div align="center">
                <a class="btn btn-danger" href="index.php?table=loaitin" role="button" >Hủy</a>
                              ...
                              <div class="modal fade" id="myModal" role="dialog">
                              	...
                              	<!-- Modal content-->
                              		<div class="modal-content">
                              			...
                              			<form action="index.php?table=loaitin&thaotac=them" method="post" enctype="multipart/form-data">
                              		<div class="modal-body">
                              		<table align="center">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $value["AnHien"];?></td>
                                         <td align="center"><a class="btn btn-warning" href="index.php?table=loaitin&thaotac=xoa&idLT=<?php echo $value['idLT'];?>">Xóa</a>
                                        <a class="btn btn-primary" href="index.php?table=loaitin&thaotac=sua&idLT=<?php echo $value['idLT'];?>">Sửa</td>
                                        <?php  }?>
										</tr>
                                    </tbody>
                                </table>
...
<?php
 ...
 { 
  ...
  { 
	...
	?>
	<script type="text/javascript">window.location='index.php?table=loaitin'</script>
	<?php
	  	}
  }
 }
