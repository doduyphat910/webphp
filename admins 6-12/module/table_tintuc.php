        ...
        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
         ...
         <tbody>
          <tr>
           ...
           <td><a href="trangchu.php?table=tintuc&thaotac=xoa&idTinTuc=<?php echo $value['idTinTuc']?>" 
            class="btn btn-warning" onclick="return confirm('Are you sure?')">Xóa</a>
            ...
            <a href="trangchu.php?table=tintuc&thaotac=sua&idTinTuc=<?php echo $value['idTinTuc']?>" 
