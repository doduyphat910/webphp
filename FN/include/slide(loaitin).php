...
$idLT=$_GET['idLT'];
$obj = new tintuc();
$get1NewsByTypeSliderActive= $obj ->get1NewsByTypeSliderActive($idLT);
$get2NewsByTypeSliderItems= $obj -> get2NewsByTypeSliderItems($idLT);
?>
...
<div class="featured container">
 <div class="row">
  <div class="col-sm-8" >
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
     ...
     <div class="carousel-inner">
      <?php foreach($get1NewsByTypeSliderActive as $ImgS)
      {
      ?>
        ...
        <?php
        foreach($get2NewsByTypeSliderItems as $Img)
        {
          ?>
  ...
  <div class="col-sm-4 tinmoinhat">
    <?php
    $get2NewsByType = $obj ->get2NewsByType($idLT);
    foreach ($get2NewsByType as $key => $value) {
      ?>    
      <div class="row">
        <div class="col-md-12">
