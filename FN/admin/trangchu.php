  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <h4 class="navbar-brand">Admin 247</h4> 
      </div>
      ...
      <form action="trangchu.php" method="get" >
        	<div style="margin-top: 20px;"> Xin chào, <?php echo $_SESSION['admin']['HoTenUser'];?>
        ...
        <div class="sidebar-collapse">
          <ul class="nav" id="main-menu">
            <li class="text-center">
              <a href="trangchu.php?table=thongso"> <img src="assets/img/find_user.png" class="user-image img-responsive"/></a>
            </li>


            <li>
              <a href="trangchu.php?table=thongso"><i class="fa fa-dashboard fa-3x"></i> Thông số web</a>
            </li>
            <li>
            ...
            <li>
              <a  href="trangchu.php?table=binhchon"><i class="fa fa-table fa-3x"></i> Table Bình Chọn</a>
            </li>
            <li>
              <a  href="trangchu.php?table=phuonganbinhchon"><i class="fa fa-table fa-3x"></i> Table Phương Án Bình Chọn</a>
            </li>
            <li>
         ...
         {          
          ...
          elseif($_GET["table"]=="traloibinhluan"){
            ...
            include("module/table_traloibinhluan.php");	 
			 ...
			 elseif($_GET["table"]=="binhchon"){

            include("module/table_binhchon.php");	 
          }
			  elseif($_GET["table"]=="phuonganbinhchon"){

            include("module/table_phuonganbinhchon.php");	 
          }
			 elseif($_GET["table"]=="noidung")
		 {
			  include("module/table_noidung.php");
		 }
			 elseif($_GET["table"]=="thongso")
		{
			 include("module/table_thongsoweb.php");
		}
          else
