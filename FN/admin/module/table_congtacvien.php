    ...
    if(isset($_GET['thaotac']))
{
  if($_GET['thaotac']=="sua" &&isset($_GET['idUser']))
  {
	  ...
	  //print_r($row);
  ?>
            <form action="trangchu.php?table=congtacvien&thaotac=update" method="post" enctype="multipart/form-data" >
              <div class="modal-body">
       	<table align="center">
         <?php ?>
          <tr><td>idUser: </td><td><input type="text" name="iduser" value="<?php echo $tam=$_GET['idUser']; ?> " readonly></td></tr>
          <tr><td>Họ và tên: </td><td><input type="text" name="hotenuser" value="<?php echo $row["HoTenUser"];?>" readonly></td></tr>
          <tr><td>Username: </td><td><input type="text" name="username" value="<?php echo $row["UserName"];?>" readonly></td></tr>
          <tr><td>Password: </td><td><input type="text" name="password" value="<?php echo $row["Password"];?>" readonly></td></tr>
          <tr><td>Địa chỉ: </td><td><input type="text" name="diachi" value="<?php echo $row["DiaChi"];?>" readonly></td></tr>
          <tr><td>Email: </td><td><input type="text" name="email" value="<?php echo $row["Email"];?>" readonly></td></tr>
          <tr><td>Điện thoại: </td><td><input type="text" name="dienthoai" value="<?php echo $row["DienThoai"];?>" readonly></td></tr>
          <tr><td>Giới tính:</td><td>
									<input type="radio" name="gioitinh" readonly <?php 
									  if($row['GioiTinh']==1)
									  {
										?>
									checked="checked";
          ...
          <tr><td>Ngày đăng ký :</td><td><input type="date" name="ngaydangki" value="<?php echo $row["NgayDangKi"];?>" readonly></td></tr>
          <tr><td>Ngày Sinh:</td><td><input type="date" name="ngaysinh" value="<?php echo $row["NgaySinh"];?>" readonly>
          <tr><td>Chức vụ:</td><td>
             ...
             <div align="center">
                <a class="btn btn-danger" href="trangchu.php?table=congtacvien" role="button" >Hủy</a>
			  ...
			  <div class="modal fade" id="myModal" role="dialog">
				...
				<!-- Modal content-->
					<div class="modal-content">
						...
						<form action="trangchu.php?table=congtacvien&thaotac=them" method="post" enctype="multipart/form-data">
					<div class="modal-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                       <?php 
                                        ...
                                        <td align="center"><a class="btn btn-danger glyphicon glyphicon-trash" onclick="return confirm('Are you sure?')" href="trangchu.php?table=congtacvien&thaotac=xoa&idUser=<?php echo $value['idUser'];?>"> Xóa</a>
                                        <a class="btn btn-primary glyphicon glyphicon-wrench" href="trangchu.php?table=congtacvien&thaotac=sua&idUser=<?php echo $value['idUser'];?>"> Sửa</td>
										</tr>
                                        <?php
										}
										?>
...
if(isset($_GET["thaotac"]) &&isset($_GET["idUser"]) )
 { 
  if($_GET["thaotac"]=="xoa")
  {
	  ...
	  {
		  ?>
		  <script type="text/javascript">window.location='trangchu.php?table=congtacvien'</script>
		  <?php
	  }
  }// xóa user
}
