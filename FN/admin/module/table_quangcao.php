      ...
      <div class="modal-body">
        <table align="center" width="100%">
          ...
          foreach ($showidQC as $key => $value) {
            ...
            <tr><td>Id và vị trí quảng cáo :</td><td>
              <select name="idvt"> 
           ...
           <tr><td>Hình quảng cáo :</td><td><img src="./../images/quangcao/<?php echo $value['idVT']; ?>/<?php echo $value['UrlHinh']; ?>" style="width: 150px;height: 100px;"><input type="file" name="hinhanh" /> </td></tr>
	...
	<button type="button" class="btn btn-primary btn-lg glyphicon glyphicon-plus-sign" data-toggle="modal" data-target="#myModal"> Thêm</button>
				  ...
				  <div class="modal fade" id="myModal" role="dialog">
					...
					<!-- Modal content-->
						...
						<div class="modal-body">
						<table align="center">
							<tr><td>Id và vị trí quảng cáo :<td>
												<select name="idvt"> 
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
						   <?php foreach($ShowallQC as $value)
							...
							<td><?php //echo $value['idVT'];
								$tt=$vitriads->showidVT($value['idVT']);
								$id=$vitriads->showidVT($value['idVT']);
								echo $id['idVT']."-".$tt['TenVT'];
								?></td>
							<td><?php echo $value['MoTa'];?></td>
							<td><?php echo $value['Url'];?></td>
							<td><img src="./../images/quangcao/<?php echo $value['idVT']; ?>/<?php echo $value['UrlHinh'];?>" style="width: 150px;height: 100px;"></td>
							<td><?php echo $value['NgayBatDau'];?></td>
							<td><?php echo $value['NgayKetThuc'];?></td>
							<td align="center">
							
										  <a href="trangchu.php?table=quangcao&thaotac=xoa&idQC=<?php echo $value['idQC'];?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" 
										  	class="btn btn-danger glyphicon glyphicon-trash"> Xóa</a>
...
if(isset($_GET["thaotac"]))
	...
	if($_GET["thaotac"]=="them")
		...
		if($_FILES["Urlhinh"]['name']!="")    
			...
			$ten = $h["name"];
			$tam = $h["tmp_name"];
			move_uploaded_file($tam,"./../images/quangcao/$vitri/".$ten);
			$Link=$ten;
			}
